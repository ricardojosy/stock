...
import com.ricardojosyferreira.domain.dto.TreeResponseDto;
...
public class OrderController {
	...
	public ResponseEntity<List<TreeResponseDto>> getListOrders() {
		List<TreeResponseDto> dtos = orderService.getOrders();
		if (dtos == null) {
	...
	@GetMapping("/{id}")
	@PreAuthorize("hasAuthority('SCOPE_BASIC') || hasAuthority('SCOPE_ADMIN')" )
	public ResponseEntity<TreeResponseDto> getOrder(@PathVariable("id") Long id) {
